...
<span class="championPortraitsRow">
    <span class="championPortraitsColumn">
        <span class="championPortraitsImage">
            ![PC Portrait for Raistlin](images/raistlin/portrait.png)
        </span>
        <span>
            Portrait
        </span>
...
<span class="championImagesColumn">
    <span class="championImagesRow">
        <span class="championImagesPortrait">
            ![Raistlin Console Portrait](images/raistlin/console.png)Console Portrait
        </span>
    </span>
    <span class="championImagesRow">
        <span class="championImagesChests">
            ![Raistlin Gold Chest Icon](images/raistlin/chest_gold.png)Gold Chest Icon
        </span>
        <span class="championImagesChests">
            ![Raistlin Silver Chest Icon](images/raistlin/chest_silver.png)Silver Chest Icon
        </span>
    </span>
</span>
