...
<span class="eventRosterChampion eventBuffsTooltipHolder" id="tess" style="background-image:url(images/general/unknown.png)">Tess<span class="eventBuffsTooltipContents"><strong>Event Buff Tiers:</strong><br>Unknown.</span></span>
</span>
