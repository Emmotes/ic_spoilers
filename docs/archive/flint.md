...
<span class="championPortraitsRow">
    <span class="championPortraitsColumn">
        <span class="championPortraitsImage">
            ![PC Portrait for Flint](images/flint/portrait.png)
        </span>
        <span>
            Portrait
        </span>
    ...
    <span class="championPortraitsColumn">
        <span class="championPortraitsImage">
            ![Model WebP of Flint](images/flint/model.webp)
        </span>
        <span>
            Model
        </span>
...
<span class="champStatsTableColumn">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTableInfo">
            <span style="margin-left:8px;">Dwarf</span>
        </span>
        <span class="champStatsTableStatHeader">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTableInfo">
            <span style="margin-left:8px;">148</span>
        </span>
        <span class="champStatsTableStatHeader">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTablePatrons">
            <span style="margin-left:8px;">178</span>
        </span>
    </span>
</span>
...
![Melee Icon](images/general/icon_melee.png) **Base Attack: Battleaxe** (Melee)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Melee Icon](images/general/icon_melee.png) **Base Attack: Cleaving Strike** (Melee)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Hammer of Reorx Icon](images/flint/icon_hammerofreorx.png) **Ultimate Attack: Hammer of Reorx** (Level: 70)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Forged Bonds Icon](images/flint/icon_forgedbonds.png) **Forged Bonds** (Level: 20)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Stubborn Determination Icon](images/flint/icon_stubborndetermination.png) **Stubborn Determination** (Level: 40)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Stonecunning Icon](images/flint/icon_stonecunning.png) **Stonecunning** (Level: 110)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Take The Initiative Icon](images/flint/icon_taketheinitiative.png) **Take The Initiative** (Level: 130)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Fatherly Advice Icon](images/flint/icon_fatherlyadvice.png) **Fatherly Advice** (Level: 90)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Forged in War Icon](images/flint/icon_forgedinwar.png) **Forged in War** (Level: 90)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Blood of Reorx Icon](images/flint/icon_bloodofreorx.png) **Blood of Reorx** (Level: 90)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Craft Maker Icon](images/flint/icon_craftmaker.png) **Craft Maker** (Level: 200)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Foe Breaker Icon](images/flint/icon_foebreaker.png) **Foe Breaker** (Level: 200)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Life Taker Icon](images/flint/icon_lifetaker.png) **Life Taker** (Level: 200)
...
<span class="itemTableColumn">
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Rusty Axe Icon](images/flint/29562.png)<span class="itemTooltipContents">ID: 4322**Rusty Axe**Humpf.<br><br><span style="color:var(--Flavescent)">All Champions damage +10%.</span><code>global_dps_multiplier_mult,10<br>allow_ge:true</code></span></span><span class="itemTableIcon2">![Trusty Axe Icon](images/flint/29562.png)<span class="itemTooltipContents">ID: 4323**Trusty Axe**Well, if anything does attack us tonight, I hope it's edible!<br><br><span style="color:var(--Flavescent)">All Champions damage +65%.</span><code>global_dps_multiplier_mult,65<br>allow_ge:true</code></span></span><span class="itemTableIcon3">![Gleaming Axe Icon](images/flint/29563.png)<span class="itemTooltipContents">ID: 4324**Gleaming Axe**Ah, now this is craftsmanship.<br><br><span style="color:var(--Flavescent)">All Champions damage +120%.</span><code>global_dps_multiplier_mult,120<br>allow_ge:true</code></span></span><span class="itemTableIcon4">![Tharkan Axe Icon](images/flint/29564.png)<span class="itemTooltipContents">ID: 4325**Tharkan Axe**Do you see the red star that shines above us? ~Fizban<br><br><span style="color:var(--Flavescent)">All Champions damage +230%.</span><code>global_dps_multiplier_mult,230<br>allow_ge:true</code></span></span><span class="itemTableGE">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>1</span>
        </span>
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Smelly Dagger Icon](images/flint/29577.png)<span class="itemTooltipContents">ID: 4326**Smelly Dagger**Besides, that dagger was Flint's! ~Tas<br><br><span style="color:var(--Flavescent)">Increases the health of Flint by 10%.</span><code>health_mult,10<br>allow_ge:false</code></span></span><span class="itemTableIcon2">![Whittling Knife Icon](images/flint/29577.png)<span class="itemTooltipContents">ID: 4327**Whittling Knife**Goblins! In Solace! This new Theocrat has much to answer for!<br><br><span style="color:var(--Flavescent)">Increases the health of Flint by 30%.</span><code>health_mult,30<br>allow_ge:false</code></span></span><span class="itemTableIcon3">![Woodblocks Icon](images/flint/29578.png)<span class="itemTooltipContents">ID: 4328**Woodblocks**Are we going to stand here all night, or are we going to get some dinner?<br><br><span style="color:var(--Flavescent)">Increases the health of Flint by 50%.</span><code>health_mult,50<br>allow_ge:false</code></span></span><span class="itemTableIcon4">![Woodcarved Toys Icon](images/flint/29579.png)<span class="itemTooltipContents">ID: 4329**Woodcarved Toys**I still have some of the wonderful toys you made me. ~Laurana<br><br><span style="color:var(--Flavescent)">Increases the health of Flint by 100%.</span><code>health_mult,100<br>allow_ge:false</code></span></span><span class="itemTableGE" style="background-color:unset">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>2</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Increases the health of Flint by 100%.</span>
        </span>
    </span>
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Ratty Belt Icon](images/flint/29565.png)<span class="itemTooltipContents">ID: 4330**Ratty Belt**You've learned no manners in five years. No respect for my age or my station.<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Forged Bonds ability by 10%. (Prestack)</span><code>buff_upgrade,10,20130,0<br>allow_ge:false</code></span></span><span class="itemTableIcon2">![Fine Belt Icon](images/flint/29565.png)<span class="itemTooltipContents">ID: 4331**Fine Belt**Hoisting me around like a sack of potatoes. I hope no one who knows us saw us.<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Forged Bonds ability by 30%. (Prestack)</span><code>buff_upgrade,30,20130,0<br>allow_ge:false</code></span></span><span class="itemTableIcon3">![Thick Boots Icon](images/flint/29566.png)<span class="itemTooltipContents">ID: 4332**Thick Boots**I'd follow them into a dragon's den, if it would warm my toes!<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Forged Bonds ability by 50%. (Prestack)</span><code>buff_upgrade,50,20130,0<br>allow_ge:false</code></span></span><span class="itemTableIcon4">![Brigandine Armor Icon](images/flint/29567.png)<span class="itemTooltipContents">ID: 4333**Brigandine Armor**You're like a solid rock that I can set my back against. ~Tanis<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Forged Bonds ability by 100%. (Prestack)</span><code>buff_upgrade,100,20130,0<br>allow_ge:false</code></span></span><span class="itemTableGE" style="background-color:unset">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>3</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Increases the effect of Flint's Forged Bonds ability by 100%. (Prestack)</span>
        </span>
    </span>
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Unfortunate Helm Icon](images/flint/29574.png)<span class="itemTooltipContents">ID: 4334**Unfortunate Helm**It's going to rain again. I should have stayed in Solace.<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Take The Initiative ability by 25%.</span><code>buff_upgrade,25,20133<br>allow_ge:false</code></span></span><span class="itemTableIcon2">![Dwarven Helm Icon](images/flint/29574.png)<span class="itemTooltipContents">ID: 4335**Dwarven Helm**I remember those draconian things coming at me and falling into the water...<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Take The Initiative ability by 87.5%.</span><code>buff_upgrade,87.5,20133<br>allow_ge:false</code></span></span><span class="itemTableIcon3">![Draconian Helm Icon](images/flint/29575.png)<span class="itemTooltipContents">ID: 4336**Draconian Helm**Your helm's at the bottom of the swamp. Do you want to go in after it? ~Tas<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Take The Initiative ability by 150%.</span><code>buff_upgrade,150,20133<br>allow_ge:false</code></span></span><span class="itemTableIcon4">![Griffon's Mane Helm Icon](images/flint/29576.png)<span class="itemTooltipContents">ID: 4337**Griffon's Mane Helm**It's not horsehair! It's hair from the mane of a griffon.<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's Take The Initiative ability by 275%.</span><code>buff_upgrade,275,20133<br>allow_ge:false</code></span></span><span class="itemTableGE" style="background-color:unset">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>4</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Increases the effect of Flint's Take The Initiative ability by 275%.</span>
        </span>
    </span>
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Ill-Fitted Vest Icon](images/flint/29571.png)<span class="itemTooltipContents">ID: 4338**Ill-Fitted Vest**Pardon me, Respected Sire, may I be of assistance? ~Khirsah<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's first set of Specializations by 10%. (Prestack)</span><code>buff_upgrades,10,20134,20135,20136<br>allow_ge:false</code></span></span><span class="itemTableIcon2">![Fur-Lined Vest Icon](images/flint/29571.png)<span class="itemTooltipContents">ID: 4339**Fur-Lined Vest**First, Sir Flint, you must put on the padded vest. ~Khirsah<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's first set of Specializations by 30%. (Prestack)</span><code>buff_upgrades,30,20134,20135,20136<br>allow_ge:false</code></span></span><span class="itemTableIcon3">![Dragonriding Harness Icon](images/flint/29572.png)<span class="itemTooltipContents">ID: 4340**Dragonriding Harness**Sir Flint isn't accustomed to this newer model, Squire Burrfoot. ~Khirsah<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's first set of Specializations by 50%. (Prestack)</span><code>buff_upgrades,50,20134,20135,20136<br>allow_ge:false</code></span></span><span class="itemTableIcon4">![Dragonlance Icon](images/flint/29573.png)<span class="itemTooltipContents">ID: 4341**Dragonlance**Now it is your turn, dwarf! Set the lance! ~Khirsah<br><br><span style="color:var(--Flavescent)">Increases the effect of Flint's first set of Specializations by 100%. (Prestack)</span><code>buff_upgrades,100,20134,20135,20136<br>allow_ge:false</code></span></span><span class="itemTableGE" style="background-color:unset">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>5</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Increases the effect of Flint's first set of Specializations by 100%. (Prestack)</span>
        </span>
    </span>
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Fool's Gold Icon](images/flint/29568.png)<span class="itemTooltipContents">ID: 4342**Fool's Gold**I should never have left. And I'll be damned if I'm ever leaving again!<br><br><span style="color:var(--Flavescent)">Reduces the cooldown on Flint's Ultimate Attack by 10 seconds.</span><code>reduce_ultimate_cooldown,10<br>allow_ge:false</code></span></span><span class="itemTableIcon2">![Keepsake Gems Icon](images/flint/29568.png)<span class="itemTooltipContents">ID: 4343**Keepsake Gems**After one hundred and forty-eight years, I ought to have learned!<br><br><span style="color:var(--Flavescent)">Reduces the cooldown on Flint's Ultimate Attack by 20 seconds.</span><code>reduce_ultimate_cooldown,20<br>allow_ge:false</code></span></span><span class="itemTableIcon3">![Dwarven Essentials Icon](images/flint/29569.png)<span class="itemTooltipContents">ID: 4344**Dwarven Essentials**Flint Fireforge carries the wine. ~Tanis<br><br><span style="color:var(--Flavescent)">Reduces the cooldown on Flint's Ultimate Attack by 40 seconds.</span><code>reduce_ultimate_cooldown,40<br>allow_ge:false</code></span></span><span class="itemTableIcon4">![Otik's Finest Icon](images/flint/29570.png)<span class="itemTooltipContents">ID: 4345**Otik's Finest**The greatest gift! Just think, Flint! ~Tas<br><br><span style="color:var(--Flavescent)">Reduces the cooldown on Flint's Ultimate Attack by 100 seconds.</span><code>reduce_ultimate_cooldown,100<br>allow_ge:false</code></span></span><span class="itemTableGE" style="background-color:unset">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>6</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Reduces the cooldown on Flint's Ultimate Attack by 100 seconds.<br/><span style="font-size:0.9em;color:var(--Bouquet)">Cap: 501 dull / 251 shiny / 126 golden.</span></span>
        </span>
    </span>
</span>
...
<span class="featTableColumn">
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Selflessness Icon](images/featicons/globaldps.png)<span class="featTooltipContents">ID: 2703**Selflessness (Flint)**Listen, lad. I want you to have my helm.<code>global_dps_multiplier_mult,10</code></span>Selflessness
        </span>
        <span class="featTableEffect">
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Inspiring Leader Icon](images/featicons/globaldps.png)<span class="featTooltipContents">ID: 2704**Inspiring Leader (Flint)**I led them here. This is my responsibility. I'm the eldest. I'll get them out.<code>global_dps_multiplier_mult,25</code></span>Inspiring Leader
        </span>
        <span class="featTableEffect">
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Tough Icon](images/featicons/health.png)<span class="featTooltipContents">ID: 2705**Tough (Flint)**He'll be fine. ~Fizban<code>health_mult,15</code></span>Tough
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the health of Flint by 15%.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Free</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Resilient Icon](images/featicons/health.png)<span class="featTooltipContents">ID: 2706**Resilient (Flint)**He'll be all right. ~Tas<code>health_mult,30</code></span>Resilient
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the health of Flint by 30%.</span>
        </span>
        <span class="featTableSource">
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Defensive Duelist Icon](images/featicons/overhelm.png)<span class="featTooltipContents">ID: 2707**Defensive Duelist (Flint)**That was great! Hit him again! ~Tas<code>overwhelm_start_increase,5</code></span>Defensive Duelist
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Flint takes 5 more Enemies attacking to get overwhelmed.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Free</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Calm Under Pressure Icon](images/featicons/overhelm.png)<span class="featTooltipContents">ID: 2708**Calm Under Pressure (Flint)**Is it too much to ask that I be allowed to die in peace?<code>overwhelm_start_increase,10</code></span>Calm Under Pressure
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Flint takes 10 more Enemies attacking to get overwhelmed.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">12,500 Gems</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon4">
            ![Sentinel Icon](images/featicons/overhelm.png)<span class="featTooltipContents">ID: 2709**Sentinel (Flint)**The dragonarmies... Our fight is not ended. Go find Flint. ~Laurana<code>overwhelm_start_increase,20</code></span>Sentinel
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Flint takes 20 more Enemies attacking to get overwhelmed.</span>
        </span>
        <span class="featTableSource">
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Proven Bond Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2710**Proven Bond (Flint)**It was a sacred oath we took, to meet again after five years had passed.<code>buff_upgrade,40,20130,0</code></span>Proven Bond
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the effect of Flint's Forged Bonds ability by 40%. (Prestack)</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Gold Chest</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon4">
            ![Saved Place Icon](images/featicons/flint.png)<span class="featTooltipContents">ID: 2711**Saved Place (Flint)**He is patient. He knows you have much yet to do. He will wait. ~Fizban<code>do_nothing</code></span>Saved Place
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Flint's Forged Bonds ability gains three extra stacks if Tasslehoff is in the formation.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Event Bonus</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Stubborn Bond Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2712**Stubborn Bond (Flint)**Because I need you, grumbling old dwarf. ~Tanis<code>do_nothing</code></span>Stubborn Bond
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Flint's Forged Bonds ability gains one extra stack.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">12,500 Gems</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Poor Initiative Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2715**Poor Initiative (Flint)**We're always last! Hurry up! ~Tas<code>buff_upgrade,20,20133</code></span>Poor Initiative
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the effect of Flint's Take The Initiative ability by 20%.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Free</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Practiced Initiative Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2716**Practiced Initiative (Flint)**Flint, you lead. ~Tanis<code>buff_upgrade,40,20133</code></span>Practiced Initiative
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the effect of Flint's Take The Initiative ability by 40%.</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">12,500 Gems</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon3">
            ![Seasoned Veteran Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2718**Seasoned Veteran (Flint)**I'm getting too old for this, Tanis.<code>buff_upgrades,40,20134,20135,20136</code></span>Seasoned Veteran
        </span>
        <span class="featTableEffect">
            <span class="featTableInner">Increases the effect of Flint's first set of Specializations by 40%. (Prestack)</span>
        </span>
        <span class="featTableSource">
            <span class="featTableInner">Gold Chest</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon4">
            ![Wizened Elder Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">ID: 2719**Wizened Elder (Flint)**Of all the hatreds, the ones between families are the cruelest.<code>buff_upgrades,80,20134,20135,20136</code></span>Wizened Elder
        </span>
        <span class="featTableEffect">
