...
<span class="championPortraitsRow">
    <span class="championPortraitsImage">
        ![PC Portrait for Aeon](images/aeon/portrait.png)Portrait
    </span>
    <span class="championPortraitsImage">
...
<span class="champStatsTableColumn">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTableInfo">
            <span style="margin-left:8px;">Goliath</span>
        </span>
        <span class="champStatsTableStatHeader">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTableInfo">
            <span style="margin-left:8px;">Bard / Artificer</span>
        </span>
        <span class="champStatsTableStatHeader">
        ...
        <span class="champStatsTablePatrons">
            <span style="margin-left:8px;">Vajra (Sometimes)</span>
        </span>
    </span>
    <span class="champStatsTableRow">
        <span class="champStatsTableInfoHeader">
    ...
    <span class="champStatsTableRow">
        ...
        <span class="champStatsTablePatrons">
            <span style="margin-left:8px;">150</span>
        </span>
    </span>
</span>
...
![Ranged Icon](images/icon_ranged.png) **Base Attack: Cane Wand** (Ranged)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Deuce Icon](images/aeon/icon_deuce.png) **Ultimate Attack: Deuce** (Level: 0)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Network of Espionage Icon](images/aeon/icon_networkofespionage.png) **Network of Espionage** (Level: 0)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Uncover Weakness Icon](images/aeon/icon_uncoverweakness.png) **Uncover Weakness** (Level: 60)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Challenge Accepted Icon](images/aeon/icon_challengeaccepted.png) **Challenge Accepted** (Level: 100)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Deuce Icon](images/aeon/icon_deuce.png) **Deuce** (Level: 130)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Immediate Infiltration Icon](images/aeon/icon_immediateinfiltration.png) **Immediate Infiltration** (Level: 150)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Play the Long Game Icon](images/aeon/icon_playthelonggame.png) **Play the Long Game** (Level: 150)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Artificer's Arsenal Icon](images/aeon/icon_artificersarsenal.png) **Artificer's Arsenal** (Level: 250)
...
<span style="font-size:1.2em;">ⓘ</span> *Note: This applies prestackitively to Challenge Accepted.*
<details><summary><em>Raw Data</em></summary>
<p>
<pre>
{
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Spy Network Icon](images/aeon/icon_spynetwork.png) **Spy Network** (Level: 250)
...
<span class="itemTableColumn">
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![An Emerging Interest Icon](images/aeon/23709.png)<span class="itemTooltipContents">**An Emerging Interest**This is difficult for folks? Seems pretty easy to me.<code>global_dps_multiplier_mult,10</code></span></span><span class="itemTableIcon2">![Sparking Cane Icon](images/aeon/23709.png)<span class="itemTooltipContents">**Sparking Cane**Skill is one thing. The tools to properly protect yourself are another.<code>global_dps_multiplier_mult,65</code></span></span><span class="itemTableIcon3">![Artificer's Walking Stick Icon](images/aeon/23710.png)<span class="itemTooltipContents">**Artificer's Walking Stick**Leave them amazed, even if it's just by going for a walk.<code>global_dps_multiplier_mult,120</code></span></span><span class="itemTableIcon4">![Antimatter Blasting Cane Icon](images/aeon/23711.png)<span class="itemTooltipContents">**Antimatter Blasting Cane**Reconsider that choice before you find out what my cane can really do.<code>global_dps_multiplier_mult,230</code></span></span><span class="itemTableGE">&nbsp;</span>
        </span>
        <span class="itemTableSlot">
            <span>1</span>
        </span>
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Start of the Show Icon](images/aeon/23724.png)<span class="itemTooltipContents">**Start of the Show**I once saw a showman that drew crowds from all around wear this...<code>buff_upgrade,25,15196,1</code></span></span><span class="itemTableIcon2">![Top Hat Icon](images/aeon/23724.png)<span class="itemTooltipContents">**Top Hat**...and from that moment on I knew exactly how I wanted to present myself.<code>buff_upgrade,87.5,15196,1</code></span></span><span class="itemTableIcon3">![Hat of the Spymaster Icon](images/aeon/23725.png)<span class="itemTooltipContents">**Hat of the Spymaster**As time went on my style and skills began to crossover...<code>buff_upgrade,150,15196,1</code></span></span><span class="itemTableIcon4">![Top Hat of Telepathy Icon](images/aeon/23726.png)<span class="itemTooltipContents">**Top Hat of Telepathy**...until eventually, they became one and the same.<code>buff_upgrade,275,15196,1</code></span></span>
        </span>
        <span class="itemTableSlot">
            <span>2</span>
        </span>
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Spy's Protection Icon](images/aeon/23718.png)<span class="itemTooltipContents">**Spy's Protection**In this world, thoughts are not safe. I know that better than most.<code>buff_upgrade,25,15197,0</code></span></span><span class="itemTableIcon2">![Ring of Mind Shielding Icon](images/aeon/23718.png)<span class="itemTooltipContents">**Ring of Mind Shielding**There's a second feature of this item most don't think about. A backup plan.<code>buff_upgrade,87.5,15197,0</code></span></span><span class="itemTableIcon3">![Necklace of Intellect Icon](images/aeon/23719.png)<span class="itemTooltipContents">**Necklace of Intellect**I need my mind and my skills to be as sharp as they can be.<code>buff_upgrade,150,15197,0</code></span></span><span class="itemTableIcon4">![Bigby's Beneficent Bracelet Icon](images/aeon/23720.png)<span class="itemTooltipContents">**Bigby's Beneficent Bracelet**A recent gift from back home. Somewhere I haven't been in a long, long time.<code>buff_upgrade,275,15197,0</code></span></span>
        </span>
        <span class="itemTableSlot">
            <span>3</span>
        </span>
        ...
        <span class="itemTableEffect">
            <span>Uncover Weakness (Prestack)</span>
        </span>
    </span>
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![A Fresh Idea Icon](images/aeon/23721.png)<span class="itemTooltipContents">**A Fresh Idea**These were just something I made in my free time...<code>buff_upgrade,25,15198,1</code></span></span><span class="itemTableIcon2">![Music Box Icon](images/aeon/23721.png)<span class="itemTooltipContents">**Music Box**...but I saw a much greater potential for them.<code>buff_upgrade,87.5,15198,1</code></span></span><span class="itemTableIcon3">![Aeon's Wonderous Music Box Icon](images/aeon/23722.png)<span class="itemTooltipContents">**Aeon's Wonderous Music Box**It's amazing the things people will just take into their homes.<code>buff_upgrade,150,15198,1</code></span></span><span class="itemTableIcon4">![Cosmic Wind-up Icon](images/aeon/23723.png)<span class="itemTooltipContents">**Cosmic Wind-up**This one... this one is just for my own collection.<code>buff_upgrade,275,15198,1</code></span></span>
        </span>
        <span class="itemTableSlot">
            <span>4</span>
        </span>
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![Elegant Disguise Icon](images/aeon/23712.png)<span class="itemTooltipContents">**Elegant Disguise**People always think of spies in black leathers and hoods...<code>buff_upgrades,25,15199,15200</code></span></span><span class="itemTableIcon2">![Glamoured Shawl Icon](images/aeon/23712.png)<span class="itemTooltipContents">**Glamoured Shawl**...never in elegant formal wear out on the town.<code>buff_upgrades,87.5,15199,15200</code></span></span><span class="itemTableIcon3">![Heels of Elvenkind Icon](images/aeon/23713.png)<span class="itemTooltipContents">**Heels of Elvenkind**These had to be specially made, but it was completely worth it.<code>buff_upgrades,150,15199,15200</code></span></span><span class="itemTableIcon4">![Gown of Whispers Icon](images/aeon/23714.png)<span class="itemTooltipContents">**Gown of Whispers**Not even a hushed conversation escapes me while in this.<code>buff_upgrades,275,15199,15200</code></span></span>
        </span>
        <span class="itemTableSlot">
            <span>5</span>
        </span>
    ...
    <span class="itemTableRow">
        <span class="itemTableIcon">
            <span class="itemTableIcon1">![A New Friend Icon](images/aeon/23715.png)<span class="itemTooltipContents">**A New Friend**This was more of a test of my own skill than anything else.<code>reduce_ultimate_cooldown,9</code></span></span><span class="itemTableIcon2">![Mark II Sparrow Icon](images/aeon/23715.png)<span class="itemTooltipContents">**Mark II Sparrow**But, to my surprise, it turned into a friend and companion.<code>reduce_ultimate_cooldown,18</code></span></span><span class="itemTableIcon3">![Mark VII 'Deuce' Icon](images/aeon/23716.png)<span class="itemTooltipContents">**Mark VII 'Deuce'**It took a while to find a form he was comfortable in...<code>reduce_ultimate_cooldown,36</code></span></span><span class="itemTableIcon4">![Mark X Pseudodragon Icon](images/aeon/23717.png)<span class="itemTooltipContents">**Mark X Pseudodragon**...but just wait until he sees what I've been working on for him.<code>reduce_ultimate_cooldown,90</code></span></span>
        </span>
        <span class="itemTableSlot">
            <span>6</span>
        </span>
...
<span class="featTableColumn">
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Selflessness Icon](images/featicons/globaldps.png)<span class="featTooltipContents">**Selflessness (Aeon)**Yes, I am going to help, but it WILL cost you!<code>global_dps_multiplier_mult,10</code></span>Selflessness
        </span>
        <span class="featTableEffect">
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![You'll Do Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">**You'll Do (Aeon)**I guess you have your uses.<code>buff_upgrade,20,15196,1</code></span>You'll Do
        </span>
        <span class="featTableEffect">
            <span>20% Inner Circle</span>
        </span>
        <span class="featTableSource">
            <span>Free</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![Are You Chicken? Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">**Are You Chicken? (Aeon)**They have no idea how far I will go to prove I'm right.<code>buff_upgrade,20,15198,1</code></span>Are You Chicken?
        </span>
        <span class="featTableEffect">
            <span>20% Challenge Accepted</span>
        </span>
        <span class="featTableSource">
            <span>Free</span>
        </span>
    ...
    <span class="featTableRow">
        <span class="featTableIcon2">
            ![The Plan Icon](images/featicons/upgradefa.png)<span class="featTooltipContents">**The Plan (Aeon)**Don't worry. They're playing right into our hands.<code>buff_upgrades,20,15199,15200</code></span>The Plan
        </span>
        <span class="featTableEffect">
...
<span class="championImagesColumn">
    <span class="championImagesRow">
        <span class="championImagesPortrait">
            ![Aeon Console Portrait](images/aeon/console.png)Console Portrait
        </span>
    </span>
    <span class="championImagesRow">
