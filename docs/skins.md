...
<span class="skinTableColumn">
    <span class="skinTableRow">
        <span class="skinTableIcon">
            ![Flayer Hunter Jaheira Portrait](images/skin_portraits/flayerhunterjaheira.png)Flayer Hunter Jaheira
        </span>
        <span class="skinTableSource">
            <span style="margin-left: 8px;">???</span>
        </span>
        <span class="skinTableCost">
            <span style="margin-right: 8px;">???: {in_flash_sales=1}</span>
        </span>
    ...
    <span class="skinTableRow">
        <span class="skinTableIcon">
            ![Flayer Hunter Krydle Portrait](images/skin_portraits/flayerhunterkrydle.png)Flayer Hunter Krydle
        </span>
        <span class="skinTableSource">
            <span style="margin-left: 8px;">???</span>
        </span>
    ...
    <span class="skinTableRow">
        <span class="skinTableIcon">
            ![Flayer Hunter Nerys Portrait](images/skin_portraits/flayerhunternerys.png)Flayer Hunter Nerys
        </span>
        <span class="skinTableSource">
    ...
    <span class="skinTableRow">
        <span class="skinTableIcon">
            ![Flayer Hunter Shandie Portrait](images/skin_portraits/flayerhuntershandie.png)Flayer Hunter Shandie
        </span>
        <span class="skinTableSource">
            <span style="margin-left: 8px;">???</span>
        </span>
    ...
    <span class="skinTableRow">
        <span class="skinTableIcon">
            ![Flayer Hunter Viconia Portrait](images/skin_portraits/flayerhunterviconia.png)Flayer Hunter Viconia
        </span>
        <span class="skinTableSource">
            <span style="margin-left: 8px;">???</span>
        </span>
