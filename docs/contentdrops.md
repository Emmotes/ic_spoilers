...
<span class="contentDropsTableColumn">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Icewind Dale: Cold As Ice (Variant 3)](images/contentdrop_portraits/icewinddale_coldasice_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Icewind Dale</span>
        </span>
        <span class="contentDropsTableAdventure">
            <span style="margin-left: 8px;">Cold As Ice</span>
        </span>
        <span class="contentDropsTableType">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Icewind Dale: Friends and Foes (Variant 3)](images/contentdrop_portraits/icewinddale_friendsandfoes_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Icewind Dale</span>
        </span>
        <span class="contentDropsTableAdventure">
            <span style="margin-left: 8px;">Friends and Foes</span>
        </span>
        <span class="contentDropsTableType">
            <span style="margin-left: 8px;">Variant #3</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Icewind Dale: The Fall of Ythryn (Variant 3)](images/contentdrop_portraits/icewinddale_thefallofythryn_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Icewind Dale</span>
        </span>
        <span class="contentDropsTableAdventure">
            <span style="margin-left: 8px;">The Fall of Ythryn</span>
        </span>
        <span class="contentDropsTableType">
            <span style="margin-left: 8px;">Variant #3</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Icewind Dale: The Spire of Iriolathas (Variant 3)](images/contentdrop_portraits/icewinddale_thespireofiriolathas_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Icewind Dale</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Witchlight: Legends and Lore (Variant 2)](images/contentdrop_portraits/witchlight_legendsandlore_2.png)
        </span>
        <span class="contentDropsTableCampaign">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Witchlight: The End (Variant 2)](images/contentdrop_portraits/witchlight_theend_2.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Witchlight</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Xaryxis: Evacuation of Waterdeep (Variant 3)](images/contentdrop_portraits/xaryxis_evacuationofwaterdeep_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Xaryxis</span>
        </span>
        <span class="contentDropsTableAdventure">
            <span style="margin-left: 8px;">Evacuation of Waterdeep</span>
        </span>
        <span class="contentDropsTableType">
            <span style="margin-left: 8px;">Variant #3</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Xaryxis: Seeds of Destruction (Variant 3)](images/contentdrop_portraits/xaryxis_seedsofdestruction_3.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Xaryxis</span>
        </span>
        <span class="contentDropsTableAdventure">
            <span style="margin-left: 8px;">Seeds of Destruction</span>
        </span>
        <span class="contentDropsTableType">
            <span style="margin-left: 8px;">Variant #3</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Fortune's Wheel: Glitch in the Mortuary (Variant 2)](images/contentdrop_portraits/fortune'swheel_glitchinthemortuary_2.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Fortune's Wheel</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Fortune's Wheel: Welcome to the Outlands (Variant 2)](images/contentdrop_portraits/fortune'swheel_welcometotheoutlands_2.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Fortune's Wheel</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Vecna: A Tale of Two Vecnas (Variant 2)](images/contentdrop_portraits/vecna_ataleoftwovecnas_2.png)
        </span>
        <span class="contentDropsTableCampaign">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Vecna: The Wizards Three (Variant 2)](images/contentdrop_portraits/vecna_thewizardsthree_2.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Vecna</span>
        </span>
