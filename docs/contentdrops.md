...
<span class="contentDropsTableColumn">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Witchlight: Legends and Lore (Adventure)](images/contentdrop_portraits/witchlight_legendsandlore_0.png)
        </span>
        <span class="contentDropsTableCampaign">
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Witchlight: Legends and Lore (Variant 1)](images/contentdrop_portraits/witchlight_legendsandlore_1.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Witchlight</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Witchlight: The End (Adventure)](images/contentdrop_portraits/witchlight_theend_0.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Witchlight</span>
        </span>
    ...
    <span class="contentDropsTableRow">
        <span class="contentDropsTableIcons">
            ![Variant Spacer](images/contentdrop_portraits/variantspacer.png) ![Witchlight: The End (Variant 1)](images/contentdrop_portraits/witchlight_theend_1.png)
        </span>
        <span class="contentDropsTableCampaign">
            <span style="margin-left: 8px;">Witchlight</span>
        </span>
