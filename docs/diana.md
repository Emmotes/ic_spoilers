...
![Melee Icon](images/icon_melee.png) **Base Attack: Javelin Staff** (Melee)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Javelin Staff Throw Icon](images/diana/icon_javelinstaffthrow.png) **Ultimate Attack: Javelin Staff Throw** (Level: 160)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![Javelin Staff Icon](images/diana/icon_javelinstaff.png) **Javelin Staff** (Level: 20)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
![We'll Be Right Back Icon](images/diana/icon_wellberightback.png) **We'll Be Right Back** (Level: 100)
