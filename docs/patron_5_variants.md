...
> Two random slots in your formation are cursed The curses change slots every 15 seconds Heroes in cursed slots are stunned and cannot attack.
</div></div>
...
> Monsters now have armored hit-based health instead of normal health
</div></div>
...
> Only event Champions can be used. Three Kobolds in a trench coat join the party. Enemies deal 200% more damage. Kobold and Goblin Champions deal 400% more damage.
</div></div>
...
> Each wave spawns 1-3 Abyssal Chickens that drops no gold nor counts towards quest progress. 
...
> Azaka's body takes up a slot in your formation, starting in area 11.
</div></div>
...
![Waterdeep: Dragon Heist Campaign Button Icon](images/general/c15.png)
...
> All champions in the odd seats have disappeared. They're all out to get you.
...
> Madcaps arrive in each area. If a Madcap hits a Champion, a Bloodspawned Madcap immediately spawns. The Bloodspawned Madcaps do not drop gold or count towards quest progress. Each time a Madcap is Bloodspawned, Champion damage is reduced by 99% for 3 seconds.
</div></div>
...
> - From area 30 onward, an earthquake occurs every 20-120 seconds. Earthquakes cause falling pieces of ice hit the Champions, dealing damage equal to 75% of their max health and stunning them for 15 seconds, subject to a DEX save. 
...
Complete Area 1025 (vs 900 for Zariel)
...
- Only one Champion of each class can be included in the formation at any time. Multiclass Champions count for all of their classes. Xerophon does not have a class for this variant.
...
![The Wild Beyond the Witchlight Campaign Button Icon](images/general/c27.png)
...
> Squiddly & Jenks join the formation. Burning Rats appear in each area. They don't drop any gold, nor do they count towards quest progress.
</div></div>
...
> Nat joins the formation. Enemies move 100% faster and deal 100% additional damage. Gold Find is reduced by 99%.
</div></div>
...
> Green Dragon Wyrmlings appear in each area. They drop no gold, nor do they count towards quest progress. Only Champions with DEX of 15 or higher can be used.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### A Familiar Behind Us

Complete Area 825 (vs 525 for Zariel)

> Champions' normal attack cooldown is increased by 5 seconds. Gale the Miniature Giant Seahorse joins the formation. Champions next to Gale have their normal attack cooldown decreased by 1 second for each familiar assigned to click enemies. Only Champions with a Charisma of 16 or higher may be used.
</div></div>
...
> Sowpig appears in each boss area with 4 armored HP and you must defeat her to progress. Gold Find is reduced by 99%.
</div></div>
...
> Escort Redeemed Zariel in slot 3, Mirt in slot 7, and Vajra in slot 9.
</div></div>
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Don't Breathe the Marsh Gas

Complete Area 825 (vs 525 for Zariel)

> Additional Marsh Gas Bubbles appear in each area. They don't drop gold, nor do they count towards quest progress. Only Champions with a Ranged or Magical base attack can be used.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Don't Blast the Brigands

Complete Area 825 (vs 575 for Zariel)

> Additional Harengon Brigands appear in each area. They don't drop gold, nor do they count towards quest progress. Fog is everywhere, impeding ranged attack. Only Champions with a melee or Magical base attack can be used.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Don't Squeeze the Spiders
...
> Only bench seats 1, 2, 4, 5, 7, 8, 10, and 11 may be used. Two Will-o'-Wisp join the formation.
</div></div>
...
> Only bench seats 1, 3, 4, 6, 7, 9, 10, and 12 may be used.
...
Two Giant Frogs join the formation in slots 5 and 6.
</div></div>
...
In Non-Boss areas, each wave spawns an extra 3-5 random Taxidermy Animals. 
They don't drop gold, or count towards quest progress.
In Boss areas, The second wave spawns a Taxidermy Monstrosity boss enemy. It must also be defeated to progress.
</div></div>
...
> A random Champion from seat 12 is immediately unlocked, added to the formation, can't be removed, but can be moved.
Champions from the first two bench seats cannot be used.
</div></div>
...
In Boss areas, Zarak appears. 
It must also be defeated to progress.
In Area 50, Zarak has 50 armored HP.
</div></div>
...
> A Bullywug joins the formation. Every 25 areas the bullywug leaps to a new formation slot of the Champion from the bench seat with the most available Champions.
Any Champion the Bullywug leaps on is knocked out for the rest of the adventure.
Champions can't be removed from the formation once they have been added.
Fire breath potions can't be used during the adventure, and click damage has no effect after area 100.
</div></div>
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Will of the Frozen Feywild

Complete Area 950 (vs 825 for Zariel)

> 1-3 Winter Eladrin spawn randomly with each wave. They don't drop gold, nor do they count toward quest progress.
You can't use Champions that have DEX as their lowest ability score, including ties.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### The Loots of Loomlurch
...
> 1-2 additional ranged spear-throwing Goblins appear with each wave.
...
Complete Area 1050 (vs 925 for Zariel)

> A giant goat joins the formation.
You can't use Champions that have WIS as their lowest ability score, including ties.
</div></div>
...
> You may only use Champions with a STR of 13 or higher.
After every 100 areas, the Champion that has dealt the most damage is removed from the formation and becomes unavailable for the rest of the adventure.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### The Invisible Wizards of Thay

Complete Area 1100 (vs 975 for Zariel)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Between a Brigganock and a Hard Place
...
Complete Area 1150 (vs 1025 for Zariel)
...
All monsters are 50% smaller in size, but move +300% faster.
</div></div>
...
Complete Area 1200 (vs 1075 for Zariel)
...
Complete Area 1250 (vs 1125 for Zariel)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### The Brains of an Illithid's Desire

Complete Area 1300 (vs 1175 for Zariel)
...
After area 750, game speed is multiplied by x3.
</div></div>
...
Complete Area 1350 (vs 1225 for Zariel)
...
Complete Area 1400 (vs 1275 for Zariel)

> You may only use Champions with the Wizard, Sorcerer, Warlock, or Bard class.
A Lesser Earth Elemental with 4 armored health spawns with each wave. They drop no gold nor count toward quest progress.
</div></div>
...
Complete Area 1450 (vs 1325 for Zariel)
...
![Light of Xaryxis Campaign Button Icon](images/general/c28.png)

<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Speeds of Destruction

Complete Area 825 (vs 425 for Zariel)

> A random Speed Champion is immediately unlocked, added to the formation, and can't be removed.
Other Speed Champions cannot be used.
</div></div>
...
> A snowy owlbear joins the formation. 
Only champions next to the Owlbear or next to a Druid Champion can deal damage.
</div></div>
...
> Flapjack joins the formation. Champions adjacent to Flapjack deal no damage as they are too distracted with thoughts of breakfast.
Every 5 seconds, a giant waffle lands on a random Champion, dealing 25% of their health in damage.
</div></div>
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### The Champion's Guide to Wildspace

Complete Area 825 (vs 575 for Zariel)

> A Plasmoid that just had its home planet destroyed joins the formation. They constantly ask questions so adjacent champions deal no damage due to the distraction.
</div></div>
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Not That Type of Helm!

Complete Area 825 (vs 625 for Zariel)

> You may only use fighters or paladins.
...
Your champions deal +1000% damage for each Bard in the formation, including the four escorts, stacking multiplicatively.
</div></div>
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### The Chaotic Hunt for The Last Breath
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### There's a Flying Snake in my Boot!

Complete Area 1100 (vs 975 for Zariel)

> Each wave spawns 1-2 flying snakes. They don't drop gold nor count towards quest progress.
...
After area 5, a temporal anomaly affects a random Champion in each area. They can't attack, be moved, or be removed until you switch areas.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### One Spelljammer at a Time
...
> Every 10 seconds of real time, Champions take 25% of their total health in damage from the citadel's magical defenses. This speeds up by 0.5 second every 100 areas (Capped at 1/second)
You may only use three Champions that don't have the Speed tag.
</div></div>


<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### 15 minutes to Doomsday
...
Anytime there are less than 10 minutes left in the countdown you can't remove Champions from the formation.
</div></div>
...
Complete Area 1500 (vs 1375 for Zariel)
...
![Turn of Fortune's Wheel Campaign Button Icon](images/general/c29.png)

<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### Tomb of Champions

Complete Area 825 (vs 150 for Zariel)
...
<div markdown="1" class="abilityBorder"><div markdown="1" class="abilityBorderInner">
### A Gnome in the Mortuary

Complete Area 900 (vs 775 for Zariel)

> Avren starts in the formation. He can be moved but not removed.
