...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        <span class="emergenceShopTableIcon">
            <span class="tooltipHolder">![Thunder Lord Briv Skin Portrait](images/premiums/skin_544.png)<span class="itemTooltipContents">ID: 544**Thunder Lord Briv (Briv)**<span style="display:flex;flex-direction:row"><img src="images/premiums/skin_544.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:min-content;max-height:100%"><img src="images/premiums/skin_544-armored.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:min-content;max-height:100%"></span></span></span>
        </span>
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Skin**</span>
