...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        <span class="emergenceShopTableIcon">
            <span class="tooltipHolder">![Fortune Hunter Tess Skin Portrait](images/premiums/skin_572.png)<span class="itemTooltipContents">ID: 572**Fortune Hunter Tess (Tess)**<img src="images/premiums/skin_572.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:min-content;max-height:100%"></span></span>
        </span>
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Skin**</span>
