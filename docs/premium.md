...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        <span class="emergenceShopTableIcon">
            <span class="tooltipHolder">![Plushie BBEG Skin Portrait](images/premiums/skin_471.png)<span class="itemTooltipContents">ID: 471**Plushie BBEG (BBEG)**<span style="display:flex;flex-direction:row"><img src="images/premiums/skin_471.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:100%;max-height:100%"><img src="images/premiums/skin_471-zombie.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:100%;max-height:100%"></span></span></span>
        </span>
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Skin**</span>
