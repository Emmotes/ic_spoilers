...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        <span class="emergenceShopTableIcon">
            <span class="tooltipHolder">![Primordial Earth Kalix Skin Portrait](images/premiums/skin_655.png)<span class="itemTooltipContents">ID: 655**Primordial Earth Kalix (Kalix)**<img src="images/premiums/skin_655.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:min-content;max-height:100%"></span></span>
        </span>
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Skin**</span>
...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        ...
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Feat**</span>
            <span style="margin-left:15px">Stand Together</span>
            <span style="margin-left:15px">Hank</span>
        </span>
    </span>
    <span class="premiumsTableItem">
