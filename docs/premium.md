...
<span class="premiumsTableRow">
    ...
    <span class="premiumsTableItem">
        <span class="emergenceShopTableIcon">
            <span class="tooltipHolder">![Unknown Skin Portrait](images/general/unknown.png)<span class="itemTooltipContents">ID: 597**Legendkeeper Alyndra (Alyndra)**<img src="images/premiums/skin_597.gif" alt="Skin  Model Gif" style="width:auto;height:auto;max-width:min-content;max-height:100%"></span></span>
        </span>
        <span class="emergenceShopTableTextColumn">
            <span style="margin-left:5px">**Skin**</span>
